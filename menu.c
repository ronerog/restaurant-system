...
void menu() {
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                adicionar_item(pedidos, &length, &total, "Hamburg�o", 30.00);
                break;
            case 2:
...
void exibir_menu() {
    printf("            Menu            \n");
    printf("1- Hamburg�o: R$ 30,00\n");
    printf("(P�o, Queijo Prato, Hamburguer Bovino de 160g, Alface e Tomate.)\n");
    printf("2- Frangolino: R$ 26,00\n");
    printf("(P�o, Peito de Frango empanado, picles e maionese da casa.)\n");
    printf("3- Batata Frita: R$ 10,00\n");
    printf("4- Onion Rings: R$ 12,00\n");
    printf("(Cebolas empanadas e fritas. Acompanha molho ros�.)\n");
